...
//dois sinais de igual antecedidos por um ponto de exclamação compara se os tipos das variáveis são diferentes 
console.log(numero !== numero2)//true

// um sinal de igual antecedido por um ponto de exclamação compara de os valores são diferentes
console.log(numero != numero2)//false